...
class AbilityButton extends React.Component<AbilityButtonProps, AbilityButtonState> {
  ...
  public componentDidMount() {
    this.activateHandle = camelotunchained.game.abilityStates[this.props.abilityInfo.id]
      .onActivated(this.handleClientActivation);
  }
  ...
  public componentWillReceiveProps(nextProps: AbilityButtonProps) {
    if (!this.updateHandle && nextProps.abilityInfo && typeof nextProps.abilityInfo.id === 'number') {
      this.updateHandle = camelotunchained.game.abilityStates[nextProps.abilityInfo.id].onUpdated(this.processEvent);
    }
  }
